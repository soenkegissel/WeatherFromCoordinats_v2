package com.example.maks2.weathertocoordinats.listeners;
...
public class OnCenterPauseScrollListener extends RecyclerView.OnScrollListener {
    ...
    public OnCenterPauseScrollListener(int centerPivot) {
